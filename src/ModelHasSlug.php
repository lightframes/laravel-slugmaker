...
namespace Lightframes\SlugMaker;
...
trait ModelHasSlug
{
    ...
    {
        return $this->morphOne(config('slugmaker.model', \Lightframes\SlugMaker\Models\Slug::class), 'slugable');
    }
    
    /**
     * Edited by Stefano to search for current slug
     * @return mixed
     */
    public function slug_current()
    {
        return $this -> slug()->where('current_slug', '=',1);
    }
